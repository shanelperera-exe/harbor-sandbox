...
export default function UserAvatar({
  ...
  if (svgString) {
    return (
      <span
        className={`flex-shrink-0 inline-flex items-center justify-center overflow-hidden ${className}`}
        style={{ width: size, height: size }}
        // Safe: SVG is generated server-side by DiceBear — no user-supplied HTML
  ...
  return (
    <span
      className={`flex-shrink-0 flex items-center justify-center font-semibold leading-none capitalize ${colourClass} ${className}`}
